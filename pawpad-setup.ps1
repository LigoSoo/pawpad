...
# - .claude/skills/* (memory, codemap, codebase-map, caveman, lean-code, feature-architecture, clarity, handoff, checkpoint, grill-me, grill-with-docs, to-prd, design, mockup, review, ctxdb-navigator, context-saver, security-check)
...
if ($failed -eq 0) {
    ...
    Write-Host ""
    Write-Host "v$ver 누적 (18 스킬 + hook + .ctxdb + codemap + codebase-map + security-check):" -ForegroundColor Cyan
