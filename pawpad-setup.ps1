...
# - .claude/skills/* (memory, codemap, codebase-map, caveman, lean-code, feature-architecture, clarity, handoff, checkpoint, grill-me, grill-with-docs, to-prd, design, ctxdb-navigator, context-saver, security-check)
...
if ($failed -eq 0) {
    ...
    Write-Host "  - 상세: docs/CHANGELOG_v2.27.md" -ForegroundColor Cyan
    Write-Host ""
} else {
